...
import { apiEndpoints, PRIORITIZATION_TENDERS } from '../../../services/ApiEndpointsConstants'
...
export function exportChecklistToPdf(requestParams = {}, checklistId, fileName) {
  return dispatch => dispatch(
    exportToPdf(
      apiEndpoints().entity(CHECKLIST_EXPORT).replace('{id}', checklistId),
      requestParams,
      fileName,
      'get',
    ),
