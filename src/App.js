...
class App extends Component {
  ...
  renderAuthenticatedPage = () => {
    const { translate, datePickerLocaleTitle, defaultMenuSize, userInfo, defaultLocaleObject } = this.props
              ...
              <Header style={{ background: '#fff', padding: '0 15px' }}>
                <Row type="flex">
                  <Col span={12}>
                    ...
                    {/*<span>{translate('main_title')}</span>*/}
                  </Col>
                  <Col span={4}>
                    <Button.Group>
                      <Button onClick={() => this.changeLocalization('ru')}
                              disabled={datePickerLocaleTitle === 'ru'}>RU</Button>
                      <Button onClick={() => this.changeLocalization('en')}
                              disabled={datePickerLocaleTitle === 'en'}>EN</Button>
                    </Button.Group>
                  </Col>
                  <Col span={8}>
