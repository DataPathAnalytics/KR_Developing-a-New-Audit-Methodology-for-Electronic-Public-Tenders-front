...
class BuyerInspectionForm extends Component {
  ...
  render() {
    const { translate, getFieldDecorator, componentImpactsKey, allMappings, onlyView, questionAnswersKey } = this.props
    const { template, showQuestionDrawer, selectedTemplate, useBaseTemplateData, createQuestionError } = this.state
