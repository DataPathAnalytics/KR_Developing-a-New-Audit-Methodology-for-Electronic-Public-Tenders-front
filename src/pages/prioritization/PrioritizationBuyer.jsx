...
import BuyerTopByIndicatorsCountChart from './components/dashboards/BuyerTopByIndicatorsCountChart'
import BuyerTopByRiskTendersAmountChart from './components/dashboards/BuyerTopByRiskTendersAmountChart'
import BuyerTopByRiskTendersCountChart from './components/dashboards/BuyerTopByRiskTendersCountChart'
        ...
        <Col span={24}>
          ...
          <Tabs onChange={this.callback} className="test-tab-class" tabPosition="top">
            <Tabs.TabPane
              ...
              <Row>
                <Col span={24} className="mb-5">
                  <BuyerTopByRiskTendersCountChart />
                </Col>
                <Col span={24} className="mb-5">
                  <BuyerTopByRiskTendersAmountChart />
                </Col>
                <Col span={24}>
                  <BuyerTopByIndicatorsCountChart />
                </Col>
              </Row>
            </Tabs.TabPane>
            <Tabs.TabPane
