...
import { PERMISSIONS } from '../secutiry/PermissionConstants'
...
class NavigationBar extends Component {
  ...
  renderMenuItem = (menuItem) => {
    ...
    return _.includes(menuItem.permissions, this.props.userInfo.permissions[0]) ? (
  ...
  prepareMenu = () => {
    return _.map(NAVIGATION_BAR_ITEMS, (menuItem) => {
        if (!_.isEmpty(menuItem.subMenu)) {
          ...
          return _.includes(menuItem.permissions, this.props.userInfo.permissions[0]) ? this.renderMenuItem(menuItem) : null
        }
      },
    )
  }
